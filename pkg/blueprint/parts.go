...
var (
	...
	llmQwen3VL8B      = Part{Kind: "llm", Name: "Qwen3-VL-8B-Instruct", Names: []string{"qwen3-vl-8b", "qwen3_vl_8b", "qwen_3_vl_8b", "qwen3vl8b"}, Arch: []string{"qwen3vl", "qwen3_vl"}, Params: []float64{8.8e9}, Repos: []string{"unsloth/Qwen3-VL-8B-Instruct-GGUF", "Qwen/Qwen3-VL-8B-Instruct"}}
