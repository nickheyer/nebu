...
>
  <AlertDialog.Portal>
    ...
    <AlertDialog.Content
      class="enter-up fixed top-1/2 left-1/2 z-[70] w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl border border-line bg-overlay p-5 shadow-pop focus:outline-none"
    >
